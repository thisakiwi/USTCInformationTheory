...
class ZipModel():
    ...
    def unzip_and_decode(self, zipped):
        ...
        arr = array.array("I")
        arr.frombytes(unzipped)
        decoded = torch.tensor(arr, dtype=torch.int32)
...
if __name__ == "__main__":
    finetuned_models = None  # 无微调模型，置空
    original_model_names = ["./code/gpt2_models"]  
    context_sizes = [1024]
    batch_size = 10 
    file_path = "./code/IT_Compression/data/enwik8_1KB.txt" 
    save_name = "gpt2_1024_1KB_test"  
